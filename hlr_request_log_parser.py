...
COUNTRY_CODES = ["1", "1242", "1246", "1264", "1268", "1284", "1340", "1345", "1441", "1473", "1649", "1664", "1671",
                 "1684", "1758", "1767", "1784", "1787", "1809", "1868", "1869", "1876", "20", "211", "212", "213",
                 "216", "218", "220", "221", "222", "223", "224", "225", "226", "227", "228", "229", "230", "231",
                 "232", "233", "234", "235", "236", "237", "238", "239", "240", "241", "242", "243", "244", "245",
                 "246", "248", "249", "250", "251", "252", "253", "254", "255", "256", "257", "258", "260", "261",
                 "262", "263", "264", "265", "266", "267", "268", "269", "27", "290", "291", "297", "298", "299", "30",
                 "31", "32", "33", "34", "350", "351", "352", "353", "354", "355", "356", "357", "358", "359", "36",
                 ...
                 "62", "63", "64", "65", "66", "670", "672", "673", "674", "675", "676", "677", "678", "679", "680",
                 "681", "682", "683", "684", "685", "686", "687", "688", "689", "690", "691", "692", "7", "77", "81",
                 "82", "84", "850", "852", "853", "855", "856", "86", "870", "880", "881", "882", "883", "883130",
                 "886", "90", "91", "92", "93", "94", "95", "960", "961", "962", "963", "964", "965", "966", "967",
                 "968", "970", "971", "972", "973", "974", "975", "976", "977", "98", "992", "993", "994", "995", "996",
                 "998"]

SOURCES = ["Life_mnp", "directory", "jtnav", "infobip", "cmtelecom", "infobip_hlr", "infobip_ltcy2", "infobip_2",
           "mitto_hlr", "mitto_mnp", "svyazcom_sure", "svyazcom_bics", "svyazcom_bics_346", "svyazcom_comfone",
           "svyazcom_comfone_134", "svyazcom_coolmessages", "tyntec_mnp", "horisen_mnp", "tyntec_hlr",
           "hlr_tyntec_e140", "tmt_mnp", "tmt_hlr", "mnp", "upstream", "mnp_kazinfotech", "messagebird", "xconnect_mnp",
           "mediafon_bkp", "mediafon_mnp", "kaleyra", "infinite_mnp", "netnumber_mnp", "netnumber_hlr", "refbook"]
...
def arg_parse():
    ...
    for sub_parser in [summary_parser, converter_parser]:
        sub_parser.add_argument(
            '-f', '--file', help='path to log file'
        )
    parser.add_argument('--sources-list', required=False, action='store_true', help='return list of sources')
...
def converter_command(arguments):
    ...
    file_out = pathlib.Path.joinpath(
        file_in.parent,
        f'{pathlib.Path(arguments.file).stem}.csv'
    )
